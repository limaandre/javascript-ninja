...
(function() {
    ...
    */
    function calculator(numUm, numDois) {
        return function(callback) {
            return callback(numUm, numDois);
        };
    }
    ...
    */
    ...
    console.log( 'O resultado da soma é: ' + sum(function(numUm, numDois) {
    ...
    */
    ...
    var multiplication = calculator(22, 2);
    var division = calculator(46, 2);
    var mod = calculator(44, 5);
    ...
    */
    ...
    console.log(subtraction(function(numUm, numDois) {
        return numUm - numDois;
    }));

    console.log( 'O resultado da multiplicação é:' );
    console.log(multiplication(function(numUm, numDois) {
        return numUm * numDois;
    }));

    console.log( 'O resultado da divisão é:' );
    console.log(division(function(numUm, numDois) {
        return numUm / numDois;
    }));

    console.log( 'O resto da divisão é:' );
    console.log(mod(function(numUm, numDois) {
        return numUm % numDois;
    }));
})();