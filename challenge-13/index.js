; (function () {
    ...
    */
    ...
    brasil.unshift('Rondônia', 'Acre', 'Amazonas');
    console.log(brasil);
    ...
    */
    var newBrasil = [];
    brasil.forEach(function(elem, index) {
    ...
    */
    ...
    var maisSeteLetra = brasil.every(function(elem) {
    ...
    */
    ...
    var temCeara = brasil.some(function(elem) {
        return elem === 'Ceará';
    })
    if (temCeara)
    ...
    */
    var map = newBrasil.map(function(elem){
        elem.id ++;
        elem.estado += " pertence ao Brasil."
        return elem;
    })
    ...
    */
    var filter = map.filter(function(elem) {
        return elem.id % 2 === 0;
    })
