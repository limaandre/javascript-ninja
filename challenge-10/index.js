...
(function() {
    ...
    */
    function calculator(operador) {
        ...
        return function(numUm, numDois) {
            ...
            if(typeof numUm !== 'number' || typeof numDois !== 'number') {
                return false;
            } 
            return operation[operador](numUm, numDois);
        };
    }
    ...
    */
    function showOperationMessage(operador, numUm, numDois) {
        return 'A operação ' + numUm + ' ' + operador + ' ' + numDois + ' = ';
    }
    ...
    */
    ...
    if(typeof multiplicação === 'function') {
        number1 = 32;
        number2 = 2;
