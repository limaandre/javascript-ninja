...
carro.adicionarPessoa = function(qtdPessoas) {
    var novoTotalPessoas = carro.quantidadePessoas + qtdPessoas;

    if (carro.assentos === carro.quantidadePessoas && novoTotalPessoas >= carro.assentos) {
        return "O carro já está lotado!";
    } 
    
    var pessoa = (carro.assentos - carro.quantidadePessoas) === 1 ? 'pessoa' : 'pessoas';
    if (novoTotalPessoas > carro.assentos ) {
        return "Só cabem mais " + (carro.assentos  - carro.quantidadePessoas) + " " + pessoa + "!!";
    }

    carro.quantidadePessoas = novoTotalPessoas;
...
carro.adicionarPessoa(4); //"Só cabem mais 1 pessoas!!"

// Faça o carro encher.
carro.adicionarPessoa(3); //"Só cabem mais 1 pessoas!!"
